...
<form action="/BookmarkGroupEditServlet" method="POST">
  <input type="hidden" name="id" value="<%= id %>">
  <table>
    <tr>
      <th>북마크 이름</th>
      <td><input type="text" name="bookmarkName" value="<%= bookmarkName %>"></td>
    </tr>
    <tr>
      <th>순서</th>
      <td><input type="text" name="sortOrder" value="<%= sortOrder %>"></td>
    </tr>
  </table>
